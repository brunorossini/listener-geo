...
(select name from osm.planet_osm_polygon WHERE admin_level = '8' AND st_contains(way, b.point) limit 1) as county,
(select name from osm.planet_osm_polygon as e WHERE admin_level = '4' and st_contains(way, b.point) limit 1) as state
